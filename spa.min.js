...
spa.Shell=function(){var b=Object.create(spa.RenderBase);b.defaultContainerSelector="#spa-shell";b.add=function(a){if(!a.name)return!1;a=this.create(a);spa.shells[a.name]=a};b.renderTemplate=function(a,b){spa.RenderBase.renderTemplate.call(this,a)};b.update=function(a){a=a||spa.shells[spa.defaults.shell];console.log("update shell continue");if(spa.current.shell===a)return!1;spa.current.shell&&spa.current.shell.unload();spa.current.shell=a;a.__setUp(this.$container)};b.unload=function(){console.log("unload shell",
arguments.callee.caller);this.$container.fadeTo("fast",0);this.__cleanUp();(this.components?this.components:[]).forEach(function(a){b.unload.call(a)}.bind(this))};b.create=function(a){return spa.RenderBase.create.call(this,a)};return b}();spa.components={};
