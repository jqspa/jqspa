...
spa.Service=function(){var b=Object.create(spa.__EventBase);b.add=function(a){if(!a.name)return!1;a=this.__declare(a);spa.services[a.name]=a};return b}();spa.models={};spa.Model=function(){var b=Object.create(spa.__EventBase);b.add=function(a){if(!a.name)return!1;a=this.__declare(a);spa.models[a.name]=a};return b}();spa.__RenderBase.errorTemplates["404"]=spa.__RenderBase.__declare({template:"<center><h1><i>Page {{name}} Not Found</i></h1>{{message}}<center>",title:"404"});
spa.__RenderBase.errorTemplates["500"]=spa.__RenderBase.__declare({title:"500",template:"<center><h1><i>SPA error {{name}}</i></h1>{{message}}<center>"});spa.shells={};
