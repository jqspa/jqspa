...
c.shift();for(var g=c.length,f=0;f<g;f++)b=c[f],0===a.children('style[class="'+b.attr("class")+'"]').length?a.append(c[f]):(c.splice(f,1),g--,f--);return c};return a}()})(jQuery);
spa.EventBase=function(){var b={create:function(a){return $.extend(Object.create(b),{__topics:{}},a||{})},init:function(){},subscribe:function(a,b){var c,d=[],f=[];$.isArray(a)||(a=[a]);for(var h=a.length;h--;)c=a[h],~d.indexOf(c)||(Object.hasOwnProperty.call(this.__topics,c)||(this.__topics[c]=[]),f.push(this.__topics[c].push(b)-1),d.push(c));return{remove:function(){for(var a=f.length;a--;)delete this.__topics[c][f[a]]}.bind(this)}},publish:function(a,b){b=b||{};if(!b.disableMiddleware&&this.__topics.__MIDDLEWARE__&&
this.__topics.__MIDDLEWARE__.length&&!this.__topics.__MIDDLEWARE__.every(function(c,d){return c(b,a)}))return!1;var c=_.split(a,":"),d=c[0];!this.__topics[d]||1>this.__topics[d].length||(c.unshift(b),this.__topics[d].forEach(function(a){setTimeout(function(b){a.apply(null,b)},0,c)}))}},a=b.create();spa.subscribe=function(b,d){return a.subscribe(b,d)};spa.publish=function(b,d){return a.publish(b,d)};spa.sub=spa.subscribe;spa.pub=spa.publish;return b}();
spa.RenderBase=function(){var b={errorTemplates:{},loadingText:"Loading...",create:function(a){return $.extend(Object.create(this),{setTimeoutMap:{},setIntervalMap:{},$container:jQuery({}),context:{},template:"",cssRules:"",__subs:[]},a||{})},loadingStart:function(){this.$container.before(this.loadingText)},__setUp:function(a){this.$container=a;this.$container.addClass(this.name);this.loadingStart();this.init()},__parse_style:function(){var a=jQuery('<style class="'+this.name+'-style">');a.append(this.cssRules||
"");this.sheet=spa.$cache.$styleSheets.push(a)},__cleanUp:function(){this.__clearSets();this.__clearSubs();this.$container.removeClass(this.name);spa.$cache.$styleSheets.unload(this.$container.attr("class")+"-style")},on:function(a,b,d){return this.$container.on.apply(this.$container,arguments)},trigger:function(a,b,d){return this.$container.trigger.apply(this.$container,arguments)},setTimeout:function(a,b,d,e){this.setTimeoutMap[a]=window.setTimeout.apply(window,Array.apply(this,arguments).splice(1));
return this.setTimeoutMap[a]},setInterval:function(a,b,d,e){this.setIntervalMap[a]=window.setInterval.apply(window,Array.apply(this,arguments).splice(1));return this.setIntervalMap[a]},subscribe:function(a,b){this.__subs.push(spa.subscribe(a,b))}};b.publish=spa.publish;b.__clearSubs=function(){this.__subs.forEach(function(a){a.remove()})};b.__clearSets=function(){for(var a in this.setIntervalMap)clearInterval(this.setIntervalMap[a]);for(a in this.setTimeoutMap)clearTimeout(this.setTimeoutMap[a])};
b.init=function(){this.renderTemplate()};b.renderTemplate=function(a,b){this.sheet||this.__parse_style();this.$container.html(Mustache.render(this.template,jQuery.extend({},this.context,a||{}),jQuery.extend({},this.templateMap,b||{})));this.components=this.$find(this.$container)};b.$find=function(a,b){var c=[];a.find("[data-component-name]").each(function(a,b){var d,e=jQuery(b);d=e.data("component-name");var g=spa.components[d];d=g?e.parents('[data-component-name="'+d+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:d}}):
g():spa.Component.errorTemplates["404"].create({context:{name:d}});c.push(d);d.__setUp(e)});return c};b.$insert=function(a,b){var c;c=a.data("component-name");var e=spa.components[c];c=e?a.parents('[data-component-name="'+c+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:c}}):e(b||{}):spa.Component.errorTemplates["404"].create({context:{name:c}});this.components.push(c);c.__setUp(a);return c};return b}();spa.services={};
spa.Service=function(){var b=Object.create(spa.EventBase);b.add=function(a){if(!a.name)return!1;a=this.create(a);a.init();spa.services[a.name]=a};return b}();spa.models={};spa.Model=function(){var b=Object.create(spa.EventBase);b.add=function(a){if(!a.name)return!1;a=this.create(a);spa.models[a.name]=a;a.init()};return b}();
spa.RenderBase.errorTemplates["404"]=spa.RenderBase.create({title:"404",template:"<center><h1><i>Page {{name}} Not Found</i></h1>{{message}}<center>",create:function(b){b.template=b.template||this.template;return spa.RenderBase.create(b)}});spa.RenderBase.errorTemplates["500"]=spa.RenderBase.create({title:"500",template:"<center><h1><i>SPA error {{name}}</i></h1>{{message}}<center>",create:function(b){b.template=b.template||this.template;return spa.RenderBase.create(b)}});spa.shells={};
spa.Shell=function(){var b=Object.create(spa.RenderBase);b.defaultContainerSelector="#spa-shell";b.add=function(a){if(!a.name)return!1;a=this.create(a);spa.shells[a.name]=a};b.renderTemplate=function(a,b){spa.RenderBase.renderTemplate.call(this,a)};b.update=function(a){a=a||spa.shells[spa.defaults.shell];if(spa.current.shell===a)return!1;spa.current.shell&&spa.current.shell.unload();spa.current.shell=a;a.__setUp(this.$container)};b.unload=function(){this.__cleanUp();(this.components?this.components:
[]).forEach(function(a){b.unload.call(a)}.bind(this))};b.create=function(a){return spa.RenderBase.create.call(this,a)};return b}();spa.components={};spa.Component=function(){var b=Object.create(spa.RenderBase);b.add=function(a){if(!a.name)return!1;spa.components[a.name]=function(b){b=b?$.extend(Object.create(a),b):a;return this.create(b)}.bind(this)};b.create=function(a){return spa.RenderBase.create.call(this,a)};return b}();
