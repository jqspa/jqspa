var spa={};(function(b){jQuery.holdReady(!0);spa={$cache:{},routes:[],current:{},defualts:{shell:"index"},inits:[],init:function(a){spa.inits.push(a)},onInit:function(){spa.inits.forEach(function(a){a()})},includeScript:function(a){jQuery.ajax({url:a,dataType:"script",async:!1})},includeTemplate:function(a){var b="";jQuery.ajax({url:a,success:function(a){b=a},async:!1});return b}}})(jQuery);
spa.EventBase=function(){var b={setTimeoutMap:{},setIntervalMap:{},listeners:{}};b.$container=jQuery({});b.on=function(a,b,c){return this.$container.on.apply(this.$container,arguments)};b.trigger=function(a,b,c){return this.$container.trigger.apply(this.$container,arguments)};b.setTimeOut=function(a,b,c,f){this.setTimeoutMap[a]=window.setTimeOut.apply(window,Array.apply(this,arguments).splice(1));return this.setTimeoutMap[a]};b.setInterval=function(a,b,c,f){this.setIntervalMap[a]=window.setInterval.apply(window,
Array.apply(this,arguments).splice(1));return this.setIntervalMap[a]};b.__clearSets=function(){for(var a in this.setIntervalMap)clearInterval(this.setIntervalMap[a]);for(a in this.setTimeoutMap)clearTimeout(this.setTimeoutMap[a])};b.unload=function(){this.__clearSets()};b.__declare=function(a){var b=Object.create(this);return jQuery.extend(b,a)};b.__topics={};b.subscribe=function(a,b){this.__topics[a]||(this.__topics[a]=[]);this.__topics[a].push(b)};b.publish=function(a,b){!this.__topics[a]||1>this.__topics[a].length||
this.__topics[a].forEach(function(a){a(b||{})})};return b}();spa.RenderBase=function(){var b=Object.create(spa.EventBase);b.context={};b.template="";b.errorTemplates={};b.__setUp=function(a){this.$container=a;this.init()};b.init=function(){this.renderTemplate()};b.renderTemplate=function(a){this.$container.html(Mustache.render(this.template,jQuery.extend({},this.context,a)));this.components=spa.Component.$find(this.$container)};return b}();spa.services={};
spa.Service=function(){var b=Object.create(spa.EventBase);b.add=function(a){if(!a.name)return!1;a=this.__declare(a);spa.services[a.name]=a};return b}();spa.models={};spa.Model=function(){var b=Object.create(spa.EventBase);b.add=function(a){if(!a.name)return!1;a=this.__declare(a);spa.models[a.name]=a};return b}();spa.RenderBase.errorTemplates["404"]=spa.RenderBase.__declare({template:"<center><h1><i>Page {{name}} Not Found</i></h1>{{message}}<center>",title:"404"});
spa.RenderBase.errorTemplates["500"]=spa.RenderBase.__declare({title:"500",template:"<center><h1><i>SPA error {{name}}</i></h1>{{message}}<center>"});spa.shells={};
...
jQuery(document).on("DOMContentLoaded",function(b){spa.$cache.$loader=jQuery("#spa-loader-holder");spa.$cache.$body=jQuery("body");spa.Shell.$container=jQuery(spa.Shell.defualtContainerSelector);jQuery(window).on("popstate",function(a){spa.Page.resolver(window.location.pathname,!1)});spa.$cache.$body.on("click",".ajax-link",function(a){a.preventDefault();spa.Page.resolver(jQuery(this).attr("href"));return!1});spa.onInit();spa.Page.resolver(window.location.pathname,!1);spa.$cache.$loader.hide();spa.Shell.$container.show()});
