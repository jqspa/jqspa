...
function(a){b--;0===b&&spa.EventBase.publish("__spa-ready")})})()});jQuery(window).load(spa.onInit);jQuery(document).on("DOMContentLoaded",function(b){spa.EventBase.publish("___dom-content-loaded-start");spa.EventBase.publish("___dom-content-loaded-end")});
