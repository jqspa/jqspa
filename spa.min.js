...
this.__topics.__MIDDLEWARE__.length&&!this.__topics.__MIDDLEWARE__.every(function(b,d){return b(c,a)}))return!1;!this.__topics[a]||1>this.__topics[a].length||this.__topics[a].forEach(function(b){setTimeout(function(a,c){b(a,c)},0,c,a)})}},c=a.create();spa.subscribe=function(a,d){c.subscribe(a,d)};spa.publish=function(a,d){c.publish(a,d)};return a}();
