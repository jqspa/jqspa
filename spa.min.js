...
b.init=function(){this.renderTemplate()};b.renderTemplate=function(a,b){this.sheet||this.__parse_style();this.$container.hide();this.$container.html(Mustache.render(this.template,jQuery.extend({},this.context,a||{}),jQuery.extend({},this.templateMap,b||{})));this.components=this.$find(this.$container);this.$container.fadeIn("slow")};b.$find=function(a,b){var c=[];a.find("[data-component-name]").each(function(a,b){var d,e=jQuery(b);d=e.data("component-name");var g=spa.components[d];d=g?e.parents('[data-component-name="'+
