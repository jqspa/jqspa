...
this.__topics.__MIDDLEWARE__.length&&!this.__topics.__MIDDLEWARE__.every(function(b,d){return b(c,a)}))return!1;var b=_.split(a,":"),d=b[0];!this.__topics[d]||1>this.__topics[d].length||(b.unshift(c),this.__topics[d].forEach(function(a){setTimeout(function(c){a.apply(null,c)},0,b)}))}},c=a.create();spa.subscribe=function(a,d){c.subscribe(a,d)};spa.publish=function(a,d){c.publish(a,d)};spa.sub=spa.subscribe;spa.pub=spa.publish;return a}();
