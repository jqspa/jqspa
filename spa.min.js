...
spa.EventBase=function(){var a={create:function(c){return $.extend(Object.create(a),{__topics:{}},c||{})},init:function(){},subscribe:function(a,c){var b,d=[],e=[];$.isArray(a)||(a=[a]);for(var h=a.length;h--;)b=a[h],~d.indexOf(b)||(Object.hasOwnProperty.call(this.__topics,b)||(this.__topics[b]=[]),e.push(this.__topics[b].push(c)-1),d.push(b));return{remove:function(){for(var a=e.length;a--;)delete this.__topics[b][a]}.bind(this)}},publish:function(a,c){!this.__topics[a]||1>this.__topics[a].length||
this.__topics[a].forEach(function(b){setTimeout(function(a,c){b(a||{},c)},0,c,a)})}},c=a.create();spa.subscribe=function(a,d){c.subscribe(a,d)};spa.publish=function(a,d){c.publish(a,d)};return a}();
