var spa=spa||{};
(function(b){jQuery.holdReady(!0);spa=jQuery.extend({buildTaskCount:0,$cache:{},routes:[],current:{},defualts:{shell:"index"}},spa);spa.inits=[];spa.init=function(a){spa.inits.push(a)};spa.onInit=function(){spa.inits.forEach(function(a){a()})};spa.includeScript=function(a){jQuery.ajax({url:a,dataType:"script",async:!1})};spa.includeTemplate=function(a){var e="";jQuery.ajax({url:a,success:function(a){e=a},async:!1});return e};spa.Mixer=function(){for(var a=[].slice.apply(arguments),e={create:function(c){for(var d=
{},f=0;f<a.length;f++)d=b.extend(d,a[f].create());d=b.extend(Object.create(d),e);return b.extend(Object.create(d),c||{})},__cleanUp:function(){for(var e=0;e<a.length;e++)a[e].__cleanUp&&a[e].__cleanUp.call(this)}},c={},d=0;d<a.length;d++)c=b.extend(Object.create(c),a[d]);return b.extend(Object.create(c),e)};spa.StyleSheets=function(){var a=Object.create(Array.prototype);a.create=function(){var a=[].slice.apply(arguments),c=jQuery("head");c.length&&(a.unshift(c),a=this.load.apply(this,a));return b.extend(Object.create(this),
a)};a.push=function(){var a=[].slice.apply(arguments),b=jQuery("head");b.length&&(a.unshift(b),a=this.load.apply(this,a));return Array.prototype.push.apply(this,a)};a.unload=function(a){return 0===jQuery("body ."+a).length?(a=jQuery("head style."+a),a.remove(),a=this.indexOf(a[0]),0!==~a&&this.splice(a,1),!0):!1};a.load=function(a){var b,d=[].slice.apply(arguments);d.shift();for(var h=d.length,g=0;g<h;g++)b=d[g],0===a.children('style[class="'+b.attr("class")+'"]').length?a.append(d[g]):(d.splice(g,
1),h--,g--);return d};return a}()})(jQuery);
...
spa.RenderBase=function(){var b={errorTemplates:{},create:function(a){return $.extend(Object.create(b),{context:{},template:"",cssRules:""},a||{})},__setUp:function(a){this.$container=a;this.$container.addClass(this.name);this.init()},__parse_style:function(){var a=jQuery('<style class="'+this.name+'-style">');a.append(this.cssRules||"");this.sheet=spa.$cache.$styleSheets.push(a)},__cleanUp:function(){spa.$cache.$styleSheets.unload(this.$container.attr("class")+"-style")},init:function(){this.renderTemplate()},
renderTemplate:function(a){this.sheet||this.__parse_style();this.$container.html(Mustache.render(this.template,jQuery.extend({},this.context,a)));this.components=this.$find(this.$container)},$find:function(a,b){var c=[];a.find("[data-component-name]").each(function(a,b){var e,f=jQuery(b);e=f.data("component-name");var k=spa.components[e];e=k?f.parents('[data-component-name="'+e+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:e}}):k():spa.Component.errorTemplates["404"].create({context:{name:e}});
c.push(e);e.__setUp(f)});return c},$insert:function(a,b){var c;c=a.data("component-name");var d=spa.components[c];c=d?a.parents('[data-component-name="'+c+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:c}}):d(b||{}):spa.Component.errorTemplates["404"].create({context:{name:c}});this.components.push(c);c.__setUp(a);return c}};return Object.create(b)}();spa.services={};
...
spa.Router={defaultRoute:spa.routes,add:function(b){if($.isArray(b))b.forEach(this.add);else{if(!b.uri&&!b.init)return!1;spa.routes.push(b);return!0}},lookup:function(b,a){var e=!1;b=b.replace(/^\/+/,"");a=a||this.defaultRoute;a.some(function(a){var d=XRegExp.exec(b,XRegExp(a.uri,"ix"));if(d)return a.REQ={url:b,re:d},e=a,!0});return e},resolver:function(b,a){a=void 0===a?!0:a;var e=this.lookup(b);e||(e=spa.RenderBase.errorTemplates["404"],e.context={name:b});spa.Shell.update(e.shell);e.init();a&&
spa.Router.historyAdd({url:b},e.title,b)},historyAdd:function(b,a,e){window.history.pushState(b,a,e)}};
