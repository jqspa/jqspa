var spa={};(function(b){jQuery.holdReady(!0);spa={$cache:{},routes:[],current:{},components:{},defualts:{shell:"index"},includeScript:function(a){jQuery.ajax({url:a,dataType:"script",async:!1})},templatePath:function(a){var b="";jQuery.ajax({url:a,success:function(a){b=a},async:!1});return b}}})(jQuery);
