...
Array.apply(this,arguments).splice(1));return this.setIntervalMap[a]};b.__clearSets=function(){for(var a in this.setIntervalMap)clearInterval(this.setIntervalMap[a]);for(a in this.setTimeoutMap)clearTimeout(this.setTimeoutMap[a])};b.unload=function(){this.__clearSets()};b.__declare=function(a){var b=Object.create(this);return jQuery.extend(b,a)};b.init=function(){};b.__topics={};b.subscribe=function(a,b){var d,e=[];$.isArray(a)||(a=[a]);for(var g=a.length;g--;)d=a[g],~e.indexOf(d)||(Object.hasOwnProperty.call(this.__topics,
d)||(this.__topics[d]=[]),this.__topics[d].push(b),e.push(d))};b.publish=function(a,b){!this.__topics[a]||1>this.__topics[a].length||this.__topics[a].forEach(function(a){setTimeout(function(b){a(b||{})},0,b)})};return b}();
...
spa.init(function(){spa.EventBase.subscribe("__dom-content-loaded-start",function(){spa.$cache.$loader=jQuery("#spa-loader-holder");spa.$cache.$body=jQuery("body");spa.Shell.$container=jQuery(spa.Shell.defaultContainerSelector);jQuery(window).on("popstate",function(b){spa.EventBase.publish("load-shell",{path:window.location.pathname,isHistory:!1})});spa.$cache.$body.on("click",".ajax-link",function(b){b.preventDefault();spa.EventBase.publish("load-shell",{path:jQuery(this).attr("href"),isHistory:!0});
return!1})});spa.EventBase.subscribe("__spa-ready",function(){jQuery.holdReady(!1);spa.EventBase.publish("load-shell",{path:window.location.pathname,isHistory:!1})});spa.EventBase.subscribe("load-shell",function(b){spa.Router.resolver(b.path,b.isHistory);spa.$cache.$loader.hide();spa.Shell.$container.show()});(function(){var b=spa.buildTaskCount;spa.EventBase.subscribe("__dom-content-loaded-end",function(a){0===b&&spa.EventBase.publish("__spa-ready")});spa.EventBase.subscribe("spa-build-task-complete",
function(a){b--;0===b&&spa.EventBase.publish("__spa-ready")})})()});jQuery(document).on("DOMContentLoaded",function(b){spa.EventBase.publish("__dom-content-loaded-start");spa.EventBase.publish("__dom-content-loaded-end")});
