...
spa.EventBase=function(){var b={create:function(a){return $.extend(Object.create(b),{__topics:{}},a||{})}};b.init=spa.utils.emptyFunc;b.subscribe=function(a,b){var c,d=[],f=[];$.isArray(a)||(a=[a]);for(var h=a.length;h--;)c=a[h],~d.indexOf(c)||(Object.hasOwnProperty.call(this.__topics,c)||(this.__topics[c]=[]),f.push(this.__topics[c].push(b)-1),d.push(c));return{remove:function(){for(var a=f.length;a--;)delete this.__topics[c][f[a]]}.bind(this)}};b.publish=function(a,b){b=b||{};if(!b.disableMiddleware&&
this.__topics.__MIDDLEWARE__&&this.__topics.__MIDDLEWARE__.length&&!this.__topics.__MIDDLEWARE__.every(function(c,d){return c(b,a)}))return!1;var c=_.split(a,":"),d=c[0];!this.__topics[d]||1>this.__topics[d].length||(c.unshift(b),this.__topics[d].forEach(function(a){setTimeout(function(b){a.apply(null,b)},0,c)}))};var a=b.create();spa.subscribe=function(b,d){return a.subscribe(b,d)};spa.publish=function(b,d){return a.publish(b,d)};spa.sub=spa.subscribe;spa.pub=spa.publish;return b}();
...
b.hideContainerInit=spa.utils.emptyFunc;b.hideContainer=spa.utils.emptyFunc;b.showContainer=spa.utils.emptyFunc;b.renderTemplate=function(a,b){this.$container.html(this.render(a,b));this.components=this.$find(this.$container);this.showContainer()};b.on=function(a,b,d){return this.$container.on.apply(this.$container,arguments)};b.trigger=function(a,b,d){return this.$container.trigger.apply(this.$container,arguments)};b.setTimeout=function(a,b,d,e){this.setTimeoutMap[a]=window.setTimeout.apply(window,
...
context:{name:b}}));spa.devMode&&(b+="#dev");c.init();spa.Shell.update(c.shell);spa.publish("spa-route-change",c);a&&spa.Router.historyAdd({url:b},c.title,b)},historyAdd:function(b,a,c){window.history.pushState(b,a,c)}};
