...
b.shift();for(var g=b.length,e=0;e<g;e++)c=b[e],0===a.children('style[class="'+c.attr("class")+'"]').length?a.append(b[e]):(b.splice(e,1),g--,e--);return b};return c}()})(jQuery);
spa.EventBase=function(){var a={__topics:{},create:function(c){return $.extend(Object.create(a),{__topics:{}},c||{})},init:function(){},subscribe:function(a,c){var b,d=[];$.isArray(a)||(a=[a]);for(var e=a.length;e--;)b=a[e],~d.indexOf(b)||(Object.hasOwnProperty.call(this.__topics,b)||(this.__topics[b]=[]),this.__topics[b].push(c),d.push(b))},publish:function(a,c){!this.__topics[a]||1>this.__topics[a].length||this.__topics[a].forEach(function(b){setTimeout(function(a,c){b(a||{},c)},0,c,a)})}},c=a.create();
spa.subscribe=c.subscribe;spa.publish=c.publish;return a}();
...
spa.$cache.$styleSheets.unload(this.$container.attr("class")+"-style")},on:function(a,c,b){return this.$container.on.apply(this.$container,arguments)},trigger:function(a,c,b){return this.$container.trigger.apply(this.$container,arguments)},setTimeout:function(a,c,b,d){this.setTimeoutMap[a]=window.setTimeout.apply(window,Array.apply(this,arguments).splice(1));return this.setTimeoutMap[a]},setInterval:function(a,c,b,d){this.setIntervalMap[a]=window.setInterval.apply(window,Array.apply(this,arguments).splice(1));
return this.setIntervalMap[a]},__clearSets:function(){for(var a in this.setIntervalMap)clearInterval(this.setIntervalMap[a]);for(a in this.setTimeoutMap)clearTimeout(this.setTimeoutMap[a])},init:function(){this.renderTemplate()},renderTemplate:function(a,c){this.sheet||this.__parse_style();this.$container.html(Mustache.render(this.template,jQuery.extend({},this.context,a||{}),jQuery.extend({},this.templateMap,c||{})));this.components=this.$find(this.$container)},$find:function(a,c){var b=[];a.find("[data-component-name]").each(function(a,
c){var d,e=jQuery(c);d=e.data("component-name");var f=spa.components[d];d=f?e.parents('[data-component-name="'+d+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:d}}):f():spa.Component.errorTemplates["404"].create({context:{name:d}});b.push(d);d.__setUp(e)});return b},$insert:function(a,c){var b;b=a.data("component-name");var d=spa.components[b];b=d?a.parents('[data-component-name="'+b+'"]').length?spa.Component.errorTemplates["500"].create({context:{name:b}}):d(c||{}):spa.Component.errorTemplates["404"].create({context:{name:b}});
this.components.push(b);b.__setUp(a);return b}}}();spa.services={};spa.Service=function(){var a=Object.create(spa.EventBase);a.add=function(a){if(!a.name)return!1;a=this.create(a);a.init();spa.services[a.name]=a};return a}();spa.models={};spa.Model=function(){var a=Object.create(spa.EventBase);a.add=function(a){if(!a.name)return!1;a=this.create(a);spa.models[a.name]=a;a.init()};return a}();
...
spa.EventBase.subscribe("__dom-content-loaded-end",function(c){0===a&&spa.EventBase.publish("__spa-ready");a--});spa.EventBase.subscribe("spa-build-task-complete",function(c){0===a&&spa.EventBase.publish("__spa-ready");a--})})()});jQuery(document).on("DOMContentLoaded",function(a){spa.EventBase.publish("__dom-content-loaded-start");spa.EventBase.publish("__dom-content-loaded-end")});
