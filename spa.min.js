var spa={};(function(b){jQuery.holdReady(!0);spa={$cache:{},routes:[],defualts:{shell:"index"},inits:[],init:function(a){spa.inits.push(a)},onInit:function(){spa.inits.forEach(function(a){a()})},includeScript:function(a){jQuery.ajax({url:a,dataType:"script",async:!1})},includeTemplate:function(a){var b="";jQuery.ajax({url:a,success:function(a){b=a},async:!1});return b}}})(jQuery);
